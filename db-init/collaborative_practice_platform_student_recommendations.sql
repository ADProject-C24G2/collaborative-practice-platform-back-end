...
LOCK TABLES `student_recommendations` WRITE;
/*!40000 ALTER TABLE `student_recommendations` DISABLE KEYS */;
INSERT INTO `student_recommendations` VALUES (1,1,'[1, 2, 3, 4, 5]','2025-08-06 00:39:24'),(2,2,'[1, 2, 3, 4, 5, 6]','2025-08-14 16:20:09');
/*!40000 ALTER TABLE `student_recommendations` ENABLE KEYS */;
UNLOCK TABLES;
